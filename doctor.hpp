...
public:
    ...
    multimap<double, DOCTOR> doctorsDataByRating;
    multimap<unsigned int, DOCTOR> doctorsDataByPatCount;
    multimap<unsigned int, DOCTOR> doctorsDataByStartTime;
    multimap<int, DOCTOR> doctorsDataByEndTime;
